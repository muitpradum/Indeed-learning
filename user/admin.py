...
class placementAdmin(admin.ModelAdmin):
     list_display = ('id','student_picture','student_name','college','session','batch','company','company_logo')
admin.site.register(placement,placementAdmin)

class signupAdmin(admin.ModelAdmin):
    list_display = ('name','email','mobile','profile','course','pyear','college','batch','batchid','status','passwd')
...
class mylectursAdmin(admin.ModelAdmin):
    list_display=('id','video_category','video_batch','vlink','thumnail','video_description','added_date')
admin.site.register(mylecturs,mylectursAdmin)    
...
class enotesAdmin(admin.ModelAdmin):
    list_display=('id','title','note_pic','pdf','batch','added_date')
