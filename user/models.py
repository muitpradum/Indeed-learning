...
class placement(models.Model):
    ...
    company_logo=models.ImageField(upload_to='static/company_logo',null=True)
...
class mylecturs(models.Model):
      ...
      thumnail=models.ImageField(upload_to='static/video',null=True)
